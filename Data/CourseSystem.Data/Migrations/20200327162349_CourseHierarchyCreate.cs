...
{
    public partial class CourseHierarchyCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(nullable: false),
                    DeletedOn = table.Column<DateTime>(nullable: true),
                    PlaceInLessonOrder = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Segments_Lesson_LessonId",
                        column: x => x.LessonId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lesson_IsDeleted",
                table: "Lesson",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_Segments_IsDeleted",
                table: "Segments",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_Segments_LessonId",
                table: "Segments",
                column: "LessonId");
